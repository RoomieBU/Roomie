    ...
    return (
        <div className="preferences-container">
            <div className="preferences-card">
                <h1 className="preferences-title">Roommate Preferences:</h1>
                <div className="preferences-instructions">
                    <p>Enter your <em>honest</em> preferences so we can guarantee you the best roommate match possible. For the slider, the left represents "strongly disagree", and the right represents "strongly agree".</p>
                </div>
                    ...
                    <div className="preferences-grid">
                        <div className="slider-column">
                            {["morning_person", "night_owl", "introvert", "extrovert", "guests_often", "okay_with_guests"].map((field) => (
                                <div className="slider-group" key={field}>
                                    <label className="slider-label">{field.replace(/_/g, ' ').replace(/\b\w/g, c => c.toUpperCase())}</label>
                        ...
                        <div className="checkbox-column">
                            <div className="checkbox-group">
                                ...
                                <label className="form-check-label" htmlFor="pet_friendly">Okay with pets?</label>
                            </div>
